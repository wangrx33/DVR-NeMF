...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='2_ablation_rr_27_rn_20',
                        help='experiment name')
    parser.add_argument("--patient_id", type=int, default=2,
                        help='patient id')
    ...
    # rendering options
    parser.add_argument("--N_samples", type=int, default=27, 
                        help='number of coarse samples per ray')
    parser.add_argument("--N_neigh", type=int, default=20, 
                        help='number of coarse samples per ray')
