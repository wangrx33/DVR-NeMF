...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='pig_001_student',
                        help='experiment name')
    parser.add_argument("--patient_id", type=int, default=1,
                        help='patient id')
    parser.add_argument("--basedir", type=str, default='./logs/', 
                        help='where to store ckpts and logs')
    parser.add_argument("--datadir", type=str, default='../dataset/mri/bio-simulator', 
                        help='input data directory')
    parser.add_argument("--pretrain", type=str, default='./logs/pig_001/001000.tar', 
                        help='input data directory')
...
def train():
    ...
    if args.dataset_type == 'mri':
        trainset, testset = load_mri_data_biosimulator(args.datadir, args.patient_id)
