...
writer = SummaryWriter('./training_logs/wo_gaussian')

from load_mri_abalation import *
from run_nerf_helpers_ablation_gaussian import *
...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='12_ablation_wo_gaussian',
