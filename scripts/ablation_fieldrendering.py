...
def create_nerf(D,H,W,args):
    ...
    model = NeRF_wofr(D=args.netdepth, W=[128, 256, 256, 512, 256, 256, 256, 256],
...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='12_ablation_wo_fieldrendering',
    ...
    parser.add_argument("--N_rand", type=int, default=1024*16, 
